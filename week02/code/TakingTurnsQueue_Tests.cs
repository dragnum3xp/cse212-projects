...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: A person with 1 turn remaining is not re-enqueued correctly
    ...
    // Defect(s) Found: The queue empties prematurely due to not re-adding people withTurns == 1.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: People with 0 turns are treated as if they have no turns left.
